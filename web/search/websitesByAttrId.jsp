...
<html>
    <head>
        ...
        <title>星象仪 - 属性：${attr.attrName}</title>
        <!-- CSS文件 -->
        <link type="text/css" rel="stylesheet" href="css/global.css" />
        <link type="text/css" rel="stylesheet" href="css/search/websitesByAttrId.css" />
        <!-- JS文件 -->
        <script type="text/javascript" src="js/jquery.js"></script>
        <script type="text/javascript" src="js/search/websitesByAttrId.js"></script>
    </head>
    <body>
        <%-- 头部 --%>
        ...
        <div class="wrapper">
            <div class="search">
                <s:form action="search/websites" method="get" theme="simple">
                    <s:hidden name="by" value="attrId" />
                    <s:hidden name="searchCondition.attrId" value="%{#request.attr.attrId}" />
                ...
                <h1>属性：${attr.attrName}（${websiteNum}个）</h1>
                <a class="list" href="#"></a>
                <a class="grid" href="#"></a>
