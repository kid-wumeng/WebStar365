...
<!-- CSS文件 -->
<link type="text/css" rel="stylesheet" href="css/search/websites_list.css" />
<!-- JS文件 -->
<script type="text/javascript" src="js/search/websites_list.js"></script>
<hr class="hr1" />
<div class="main">
    <s:iterator value="websites" id="website">
    <div class="website"><%-- 每个网站 --%>
        ...
        <div class="row2"><%-- 第二行（星数、分数） --%>
            ...
            <a class="websiteDetails" href="website/website?website.websiteId=${websiteId}">>> 详情与评论</a>
        </div>
        <div class="websiteBriefIntro"><%-- 简介 --%>
            <p>${websiteBriefIntro}</p>
        </div>
        <div class="row3"><%-- 第三行（分类、属性） --%>
            <span class="websiteCat">
                <a class="cat${websiteCat.catId}">${websiteCat.catName}</a>
            </span>
